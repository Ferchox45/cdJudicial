...
export class BusquedaProfService {
  ...
  getCatalogoBusqueda(): Observable<CatalogoBusqueda> {
    const call$ = this.http
      .get<{ data: CatalogoBusqueda }>(`${this.apiEndpoint}/api/busquedas/filtros`)
  ...
  buscarApelaciones(params: any, page: number, limit: number): Observable<PagedResultProf> {
    ...
    return this.http
      .get<ApiResponseBusqProf>(`${this.apiEndpoint}/api/busquedas/`, { params: httpParams })
      .pipe(
