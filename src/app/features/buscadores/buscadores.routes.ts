...
export const BUSCADORES_ROUTES: Routes = [
  {
    ...
    loadComponent: () =>
      import('./buscador-historico/buscadorHistorico.component').then(
        (m) => m.BuscadorHistoricoComponent,
      ),
  ...
  },
  {
    path: 'buscadorPlano',
    loadComponent: () =>
      import('./buscador-plano/buscadorPlano.component').then((m) => m.BuscadorPlanoComponent),
